...
public class DirectPurchaseTest extends BaseTest {
    ...
    public void testDirectAddToCartAndCheckout(Map<String, String> data) {
        Reporter.log("Starting direct purchase test with ID: " + data.get("id"), true);
        ...
        Reporter.log("Adding product ID: " + productId + " to cart after hovering", true);
        ...
        Reporter.log("Direct purchase test completed for: " + data.get("id"), true);
    }
}